...
const REPLACEMENTS: ReadonlyArray<[string, string]> = [
  ...
  ["ACPhasorScreenSummaryContent", `${newPrefix}ScreenSummaryContent`],
  ["ACPhasorKeyboardHelpContent", `${newPrefix}KeyboardHelpContent`],
  ["ACPhasorPreferencesModel", `${newPrefix}PreferencesModel`],
  ["ACPhasorPreferencesNode", `${newPrefix}PreferencesNode`],
  ["ACPhasorScreenView", `${newPrefix}ScreenView`],
  ["ACPhasorColors", `${newPrefix}Colors`],
  ["ACPhasorNamespace", `${newPrefix}Namespace`],
  ["ACPhasorScreen", `${newPrefix}Screen`],
  ["ACPhasorModel", `${newPrefix}Model`],
  // camelCase identifier
  ["acPhasorQueryParameters", `${newCamel}QueryParameters`],
  // Display strings
  ["AC Phasor", newName],
  // Kebab identifiers (path segments and package name)
  ["ac-phasor", newId],
  ["ac-phasor-screen", `${newId}-screen`],
];
...
console.log(`  id:     ac-phasor → ${newId}`);
console.log(`  name:   AC Phasor → ${newName}`);

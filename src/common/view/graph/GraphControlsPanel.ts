 ...
 * - Header bar
 *
 * Ported from Resonance; remapped colors/namespace to ACPhasor and swapped the
 * i18n source from ResonanceStrings to ACPhasor's StringManager.
 */
...
export default class GraphControlsPanel {
  ...
  public createHeaderBar(): Rectangle {
    ...
    const headerFillProperty = new DerivedProperty([ACPhasorColors.panelBackgroundColorProperty], (backgroundColor) =>
...
ACPhasorNamespace.register("GraphControlsPanel", GraphControlsPanel);
